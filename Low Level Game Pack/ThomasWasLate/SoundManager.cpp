...
SoundManager::SoundManager()
{
	...
	// Simulate dopler effect with this distance and attentuation.
...
void SoundManager::playFire(Vector2f emitterLocation, Vector2f listenerLocation)
{
	...
	// Choose which of the fire sounds to play.
	switch (m_NextSound)
	{
	case 1:
		// Set the sound to the emitter location and play it if it is 
		// not already playing.
